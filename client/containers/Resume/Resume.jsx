...
class Resume extends Component {
    ...
    render() {
        ...
        resumeInfo.links.map((link, index)=>linkItems.push(<LinkItem key={index} iconType={link.name}
                                                                     target={link.target}/>));
        return (
            <div className={rootClassName}>
                <div className="resumeWrap">
                    ...
                    <div className="resumeContianer" ref="resumeContianer">
                        ...
                        <p className='personalInfo'>{resumeInfo.personalInfo}{resumeInfo.page == 'huan' ? '' :
                            <a href="http://www.yvanwang.com" className="personPage">个人网站</a>}</p>
